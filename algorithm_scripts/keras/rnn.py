...
if __name__ == "__main__":
    ...
    X_train_filename = '/glade/work/jakidxav/IPython/X/20_lead/X_train/X_train.txt'
    X_dev_filename = '/glade/work/jakidxav/IPython/X/20_lead/X_dev/X_dev.txt'
    X_val_filename = '/glade/work/jakidxav/IPython/X/20_lead/X_val/X_val.txt'
